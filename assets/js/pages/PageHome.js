...
window.DangoeulPages.PageHome = {
  ...
  <div>
    ...
    <div class="home-stat-row">
      <div class="grid-4">
        <div class="stat-card stat-card--compact fade-up">
          <div class="stat-number gradient-text">12+</div>
          <div class="stat-label">협력 농가</div>
        </div>
        <div class="stat-card stat-card--compact fade-up" style="animation-delay:0.1s">
          <div class="stat-number gradient-text">4.9</div>
          <div class="stat-label">평균 별점</div>
        </div>
        <div class="stat-card stat-card--compact fade-up" style="animation-delay:0.2s">
          <div class="stat-number gradient-text">연 3만+</div>
          <div class="stat-label">배송 박스</div>
        </div>
        <div class="stat-card stat-card--compact fade-up" style="animation-delay:0.3s">
          <div class="stat-number gradient-text">새벽</div>
          <div class="stat-label">당일·익일 도착</div>
        </div>
      </div>
    </div>
